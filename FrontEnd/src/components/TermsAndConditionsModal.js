        ...
        <div className="fixed top-0 left-0 z-50 w-screen h-screen flex items-center justify-center bg-gray-800 bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-xl">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl inter-semibold text-gray-800">Términos y Condiciones del Festival</h2>
            ...
            <div className="text-gray-700 text-base">
              <ol>
                <li className="mb-3 inter-regular"><strong>Introducción</strong><br />
                ...
                <li className="mb-3 inter-regular"><strong>Comportamiento y Seguridad</strong><br />
                ...
                <li className="mb-3 inter-regular"><strong>Propiedad intelectual</strong><br />
                ...
                <li className="mb-3 inter-regular"><strong>Legislación Aplicable</strong><br />
